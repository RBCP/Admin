...
<head>
    <title>用户登录</title>
	<link rel="stylesheet" type="text/css" href="/admin/Public/static/bootstrap/css/bootstrap.min.css" media="all">
	<link rel="stylesheet" type="text/css" href="/admin/Public/Admin/css/login.css" media="all">

	<script type="text/javascript" src="/admin/Public/static/jquery.min.js"></script>
	<script type="text/javascript" src="/admin/Public/static/bootstrap/js/bootstrap.min.js"></script>
